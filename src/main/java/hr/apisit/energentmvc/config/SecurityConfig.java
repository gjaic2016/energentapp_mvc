...
//                .requestMatchers(requestMatcherBuilder.pattern("/contracts/new/**")).hasAnyAuthority( "ADMIN")
                ...
                .requestMatchers(requestMatcherBuilder.pattern("/users/update/**")).hasAnyAuthority( "ADMIN", "MANAGER", "SUPERUSER")
                .requestMatchers(requestMatcherBuilder.pattern("/users/update/{id}")).hasAnyAuthority( "ADMIN", "MANAGER", "SUPERUSER")
                .requestMatchers(requestMatcherBuilder.pattern("/users/**")).hasAnyAuthority( "ADMIN", "MANAGER", "SUPERUSER")
