...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http, HandlerMappingIntrospector introspector) throws Exception {
        ...
        http.authorizeHttpRequests((requests) -> requests
                ...
                .requestMatchers(requestMatcherBuilder.pattern("/serviceproviders/new")).hasAnyAuthority( "ADMIN")
                ...
                .requestMatchers(requestMatcherBuilder.pattern("/services/{id}")).hasAnyAuthority( "ADMIN")
                ...
                .requestMatchers(requestMatcherBuilder.pattern("/contracts/{id}")).hasAnyAuthority( "ADMIN")
                ...
                .requestMatchers(requestMatcherBuilder.pattern("/households/{id}")).hasAnyAuthority( "ADMIN")
                ...
                .requestMatchers(requestMatcherBuilder.pattern("/owners/{id}")).hasAnyAuthority("ADMIN")
                ...
                .requestMatchers(requestMatcherBuilder.pattern(HttpMethod.POST, "/serviceproviders/**" )).hasAuthority("ADMIN")
        ).formLogin((form) -> form
