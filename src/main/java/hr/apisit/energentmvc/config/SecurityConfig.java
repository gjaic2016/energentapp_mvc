...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http, HandlerMappingIntrospector introspector) throws Exception {
        ...
        http.authorizeHttpRequests((requests) -> requests
                ...
                .requestMatchers(requestMatcherBuilder.pattern("/users/update/**")).hasAuthority( "ADMIN")
                .requestMatchers(requestMatcherBuilder.pattern("/users/update/{id}")).hasAuthority( "ADMIN")
                .requestMatchers(requestMatcherBuilder.pattern("/users/**")).hasAuthority( "ADMIN")
